...
if run_clicked and topic.strip():
    ...
    st.markdown("""
    <hr>
    <div style="display:flex;align-items:center;justify-content:center;gap:0.6rem;padding:1rem 0 0.5rem;">
    <span style="font-family:'Space Mono',monospace;font-size:0.65rem;letter-spacing:0.15em;text-transform:uppercase;color:#3d3d60;">Provided by</span>
    <span style="font-family:'Syne',sans-serif;font-size:0.95rem;font-weight:700;background:linear-gradient(120deg,#818cf8,#38bdf8 45%,#34d399);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;letter-spacing:0.04em;">NEERAJ</span>
    </div>
    """, unsafe_allow_html=True)
